module.exports = [
"[project]/.next-internal/server/app/api/admin/chunks/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/admin/chunks/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function isEmailAdmin(email) {
    const list = (process.env.ADMIN_EMAILS || process.env.NEXT_PUBLIC_ADMIN_EMAILS || "").split(",").map((s)=>s.trim().toLowerCase()).filter(Boolean);
...
async function requireAdmin() {
    ...
    if (!(role === "admin" || isEmailAdmin(email))) throw new Response("Forbidden", {
        status: 403
    });
}
function supa() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(("TURBOPACK compile-time value", "https://jgxiskoaidnkcsrfuoal.supabase.co"), process.env.SUPABASE_SERVICE_ROLE, {
        auth: {
...
async function GET(req) {
    try {
        ...
        let query = supa().from("chunks").select("id, content, source, url, created_at, updated_at", {
            count: "exact"
        }).order("created_at", {
            ascending: false
...
async function POST(req) {
    try {
        ...
        if (!content?.trim()) return Response.json({
            error: "No content"
        }, {
            status: 400
        });
        ...
        if (!vRes.ok) return Response.json({
        ...
        const { data, error } = await supa().from("chunks").insert({
            content,
            url,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2fd26081._.js.map